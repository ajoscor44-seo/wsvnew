...
export const LegalPage = () => {
  ...
  return (
    <div className="min-h-screen pt-16 sm:pt-20 pb-12 sm:pb-16 px-margin-mobile sm:px-margin-desktop bg-surface text-on-surface relative overflow-hidden">
      {/* Background polish */}
      ...
      >
        <div className="mb-6 sm:mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display-lg text-white tracking-tighter leading-none mb-3 sm:mb-4">
        ...
        <div className="prose prose-emerald max-w-none space-y-8 sm:space-y-12 text-on-surface-variant leading-relaxed font-medium">
          ...
          <section className="space-y-4 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base">
              ...
              This data is utilized exclusively for generating VCF downloads and facilitating network synchronization.
            </p>
          </section>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-6">
